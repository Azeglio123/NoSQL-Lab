...
```{python}
#| label: most-active-launchpads-visual
...
ax.set_title("Most Active SpaceX Launchpads")
ax.set_xlim(0, max(launches) + 40)
ax.invert_yaxis()
ax.legend(loc="lower right")
plt.tight_layout()
plt.savefig("Personal_project_files/images/most_active_launchpads.png", dpi=150)
plt.show()
```

![Most Active SpaceX Launchpads](Personal_project_files/images/most_active_launchpads.png){width=90%}
...
```{python}
#| label: landing-success-rate-per-pad-result
...
```{python}
#| label: landing-success-rate-per-pad-visual
...
ax.set_title("Landing Success Rate per Landing Pad")
ax.set_xlim(0, 100)
ax.invert_yaxis()
plt.tight_layout()
...
![Landing Success Rate per Landing Pad](Personal_project_files/images/landing_success_per_pad.png){width=90%}
...
```{python}
#| label: landing-fail-rate-per-rocket-result
...
```{python}
#| label: landing-fail-rate-per-rocket-visual
...
ax.set_title("Landing Fail Rate per Rocket Type")
...
![Landing Fail Rate per Rocket Type](Personal_project_files/images/landing_fail_rate.png){width=90%}